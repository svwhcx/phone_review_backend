...
INSERT INTO `comment` VALUES (8, '你好个der', 1, 5, '2025-03-30 00:16:01', 0, 1, NULL, 'appending', 5);
...
CREATE TABLE `favorite`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 10 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '点赞表' ROW_FORMAT = Dynamic;
...
INSERT INTO `favorite` VALUES (3, 1, 1, '2025-03-29 22:07:13', 1);
INSERT INTO `favorite` VALUES (6, 1, 1, '2025-03-29 22:14:06', 2);
INSERT INTO `favorite` VALUES (8, 1, 1, '2025-03-29 23:56:53', 3);
...
CREATE TABLE `notification`  (
  ...
  `user_id` bigint(20) NULL DEFAULT NULL COMMENT '用户id',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 26 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '系统通知表' ROW_FORMAT = Dynamic;
...
INSERT INTO `notification` VALUES (20, '您的评论 <b>你号啊</b>已通过审核', '2025-03-30 00:04:23', 0, 'system', '/review/1', '评论审核', 5);
INSERT INTO `notification` VALUES (21, '用户 <b>svwh</b> 回复了您的评论', '2025-03-30 00:04:23', 1, 'comment-reply', '/review/1', '评论回复', 1);
INSERT INTO `notification` VALUES (22, '用户 <b>svwh</b> 评论了您的评测 <b>asdfasdfasdfasdf</b>', '2025-03-30 00:04:23', 0, 'comment', '/review/1', '新的评论', 5);
...
INSERT INTO `notification` VALUES (25, '用户 <b>svwh</b> 评论了您的评测 <b>asdfasdfasdfasdf</b>', '2025-03-30 00:05:44', 0, 'comment', '/review/1', '新的评论', 5);
...
-- Records of posts
-- ----------------------------
INSERT INTO `posts` VALUES (1, 5, 'asdfasdfasdfasdf', 'adsssssssssssssssssssssssssssssssssssssssssssssasdfffffffffffffffffffff', 4, '2025-03-29 21:00:01', NULL, NULL, NULL, 1, 'http://localhost:8080/images/49ea10ad-e5ad-4e17-8ddb-400d1a571526.jpg', 4, 3, 1, 3, 0, 2, 2, 2, NULL);
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES (1, 'test', 'test', 'user', 'C9D21E89DC04F9F2B446B4FBDAFDF4B8', NULL, 0, 1, NULL, '2606714301@qq.com', NULL, 1, 0);
INSERT INTO `user` VALUES (2, 'admin', 'admin', 'admin', 'C9D21E89DC04F9F2B446B4FBDAFDF4B8', NULL, 0, 1, NULL, NULL, NULL, 1, 0);
INSERT INTO `user` VALUES (5, 'svwhcx', 'svwh', 'admin', 'C9D21E89DC04F9F2B446B4FBDAFDF4B8', NULL, 0, 1, NULL, '1548222103@qq.com', NULL, 1, 0);
